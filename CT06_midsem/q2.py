...
# ============================================================
starting_amt=input("how much did you save at first")


# ============================================================
# Step 2: Ask for Number of Days
# ============================================================
Num_of_days=int("how much days did you save")
...
#   Day <X>: $<Y>
# ============================================================
for N in range(1,Num_of_days):
    Num_of_days=Num_of_days+1
Total=Num_of_days+starting_amt
